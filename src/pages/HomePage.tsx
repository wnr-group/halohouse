...
function HeroSection() {
  return (
    ...
    >
      <div className="w-full max-w-[1400px] mx-auto px-8 md:px-16 lg:px-24 text-center pt-20 pb-24">
        <h1
        ...
        <p
          className="text-xl md:text-2xl lg:text-3xl mb-12 max-w-5xl mx-auto"
